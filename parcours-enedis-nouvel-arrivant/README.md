...
Mise en page dynamique, ludique et pédagogique (couleurs Enedis, accessibilité WCAG AA) destinée aux **apprenants**.
...
- Objectifs pédagogiques et conseils par étape, célébrations à la validation d'une étape.
- Accessibilité : structure sémantique ARIA, navigation clavier, focus visible, respect de « prefers-reduced-motion ».

## Utilisation

Ouvrir `index.html` dans un navigateur, ou l'héberger et partager le lien aux apprenants.
